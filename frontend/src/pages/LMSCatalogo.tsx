    ...
    <Layout>
      <Box sx={{ p: 3, bgcolor: DARK_BG, minHeight: '100vh' }}>
        ...
        <Box sx={{
          ...
          bgcolor: CARD_BG, border: `1px solid ${CARD_BOR}`,
          ...
          <InputBase
            ...
            sx={{ flex: 1, color: '#FFF', fontSize: 13.5, '&::placeholder': { color: 'rgba(255,255,255,0.3)' } }}
          />
        </Box>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mb: 1.5 }}>
          {CATEGORIAS.map(c => (
            <Chip
              ...
              sx={{
                cursor: 'pointer',
                bgcolor: categoria === c ? LMS_COLOR : 'rgba(255,255,255,0.06)',
                color: categoria === c ? '#FFF' : 'rgba(255,255,255,0.5)',
                fontWeight: categoria === c ? 700 : 400,
                '&:hover': { bgcolor: categoria === c ? LMS_COLOR : 'rgba(255,255,255,0.1)' },
              }}
            />
          ))}
        </Box>
            ...
            return (
              <Chip
                ...
                sx={{
                  ...
                  border: `1px solid ${active ? alpha(col, 0.4) : 'rgba(255,255,255,0.08)'}`,
            ...
            return (
              <Grid key={c.id} size={{ xs: 12, sm: 6, lg: 4 }}>
                <Box sx={{
                  ...
                  <Typography sx={{ fontSize: 13, fontWeight: 700, color: '#FFF', mb: 0.5, lineHeight: 1.4 }}>
                    {c.nombre}
                  </Typography>
                  ...
                  <Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      ...
                      <Typography sx={{ fontSize: 11.5, color: 'rgba(255,255,255,0.5)' }}>{c.horas}h</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      <Person sx={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }} />
                      <Typography sx={{ fontSize: 11.5, color: 'rgba(255,255,255,0.5)' }}>{c.instructor}</Typography>
                    </Box>
                  </Box>

                  <Box sx={{ mt: 'auto' }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                      <Typography sx={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>{c.inscritos} inscritos</Typography>

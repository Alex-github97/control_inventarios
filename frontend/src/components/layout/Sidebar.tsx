...
import {
  ...
  PrecisionManufacturing as MESTerminalIconMES,
  ...
  ContactPage as ERPTercerosIconERP,
...
const MES_NAV_ITEMS: NavItem[] = [
  ...
  { label: 'nav.terminalPlanta',  icon: <MESTerminalIconMES     fontSize="small" />, path: '/mes/terminal',     section: 'section.produccion' },
...
const ERP_NAV_ITEMS: NavItem[] = [
  ...
  { label: 'nav.terceros',        icon: <ERPTercerosIconERP     fontSize="small" />, path: '/erp/terceros',          section: 'section.contabilidad' },
